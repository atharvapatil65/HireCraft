      ...
      <div className="container">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold text-foreground">HireCraft</h1>
          </div>
      ...
      <div className="container">
        <div className="text-center">
          <div className="inline-block mb-4">
            <span className="bg-primary/10 text-primary text-sm font-semibold px-4 py-2 rounded-full border border-primary/20">
              🎉 100% Free Job Board
            </span>
          </div>
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
            ...
            the technical edge to land offers faster. <span className="font-semibold text-foreground">Browse jobs and practice interviews completely free.</span>
          </p>
...
function Features() {
  const features = [
    ...
    },
    {
      ...
      Icon: BriefcaseIcon,
      description:
        "Browse job opportunities and apply directly. Recruiters can post jobs and manage applications all in one place.",
      isFree: true,
    },
  ]
  return (
      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            <span className="text-primary font-semibold">Free forever</span> job board and interview prep, plus premium features to accelerate your career
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map(feature => (
            <Card
              key={feature.title}
              className="transition-all duration-300 transform hover:-translate-y-1 relative"
            >
              {feature.isFree && (
                <div className="absolute top-4 right-4 z-10">
                  <span className="bg-green-500/90 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg">
                    FREE
                  </span>
                </div>
              )}
...
function FreeFeatures() {
  return (
    <section className="py-20 bg-gradient-to-br from-primary/5 via-background to-primary/10 border-y border-primary/20">
      <div className="container">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-green-500/10 text-green-600 dark:text-green-400 text-sm font-semibold px-6 py-3 rounded-full border border-green-500/20 mb-6">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Access our powerful job board and interview prep tools at no cost. Find jobs, practice interviews, and land your dream role without spending a dime.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Free Job Board */}
          <Card className="border-2 border-primary/30 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <CardHeader className="pb-4">
              <div className="flex items-center justify-between mb-4">
                <div className="w-16 h-16 bg-primary/10 flex items-center justify-center rounded-lg">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground text-lg leading-relaxed">
                Browse unlimited job opportunities and apply directly through our platform. Completely free for job seekers.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-foreground">Browse unlimited job postings</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-green-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-green-600 dark:text-green-400 text-xs">✓</span>
                  </div>
                  <span className="text-foreground">Apply directly to companies</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-green-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-green-600 dark:text-green-400 text-xs">✓</span>
                  </div>
                  <span className="text-foreground">Track your applications</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-green-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-green-600 dark:text-green-400 text-xs">✓</span>
                  </div>
                  <span className="text-foreground">Get matched with relevant opportunities</span>
                </li>
              </ul>
          ...
          <Card className="border-2 border-primary/30 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <CardHeader className="pb-4">
              <div className="flex items-center justify-between mb-4">
                <div className="w-16 h-16 bg-primary/10 flex items-center justify-center rounded-lg">
                  <BookOpenCheckIcon className="w-8 h-8 text-primary" />
                </div>
                <span className="bg-green-500 text-white text-sm font-bold px-4 py-2 rounded-full shadow-lg">
                  FREE
                </span>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground text-lg leading-relaxed">
                Practice with AI-powered interview tools and technical questions. Get ready for your next interview at no cost.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-green-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <span className="text-foreground">AI-powered mock interviews</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-green-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-green-600 dark:text-green-400 text-xs">✓</span>
                  </div>
                  <span className="text-foreground">Technical coding challenges</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-green-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-green-600 dark:text-green-400 text-xs">✓</span>
                  </div>
                  <span className="text-foreground">Behavioral question practice</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-green-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-green-600 dark:text-green-400 text-xs">✓</span>
                  </div>
                  <span className="text-foreground">Track your improvement over time</span>
                </li>
              </ul>
              <Button className="w-full mt-6" size="lg" asChild>
                <Link href="/app">
        ...
        <div className="text-center mt-12">
          <p className="text-lg text-muted-foreground mb-4">
            No hidden fees. No trials that expire. Just free, powerful tools to help you succeed.
          </p>
          <p className="text-sm text-muted-foreground">
            Want even more? Unlock premium features like advanced resume optimization and unlimited AI feedback with our affordable plans.
          </p>
        </div>
      </div>
    </section>
    ...
    <section className="py-20 bg-muted/30">
      <div className="container">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Don&apos;t just take our word for it. See how HireCraft users
  ...
  const testimonials = [
    {
      ...
      content:
        "HireCraft completely transformed my interview preparation. The AI practice sessions felt so realistic that I walked into my Google interview feeling completely confident. Landed the offer on my first try!",
      timeToOffer: "3 weeks",
    },
    {
      ...
      content:
        "I was struggling with behavioral questions until I found HireCraft. The AI helped me craft compelling stories and practice my delivery. Got offers from 3 different companies!",
      timeToOffer: "5 weeks",
    },
    {
      name: "Emily Park",
      ...
      content:
        "The resume optimization feature was a game-changer. My callback rate tripled after implementing HireCraft&apos;s suggestions. Worth every penny and more.",
      timeToOffer: "4 weeks",
    },
    {
      name: "Alex Thompson",
    ...
    },
    {
      ...
      content:
        "I was career-changing into tech and felt overwhelmed. HireCraft&apos;s personalized guidance gave me the confidence to pursue design roles. Now I&apos;m living my dream at Figma!",
      timeToOffer: "6 weeks",
    },
    {
      name: "David Kim",
      ...
      content:
        "The salary negotiation tips alone paid for the platform 10x over. I increased my offer by $25K just by following HireCraft&apos;s guidance. Absolutely worth it!",
      timeToOffer: "4 weeks",
    },
  ]
      ...
      <div className="container">
        ...
        <div className="text-center mt-12">
          <p className="text-sm text-muted-foreground mb-4">
            All plans include a 7-day refund period. Cancel anytime. <span className="font-semibold text-foreground">Free tier is always available.</span>
          </p>
        </div>
      </div>
    </section>
